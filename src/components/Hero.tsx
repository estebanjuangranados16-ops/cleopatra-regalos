...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    }, 6000); // Increased interval to reduce re-renders
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl shadow-2xl flex items-center justify-center">
