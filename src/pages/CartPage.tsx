            ...
            >
              ...
              <div className="space-y-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => {
                    const message = `Hola! Quiero consultar sobre estos productos:\n\n${cart.map(item => 
                  ...
                  className="w-full py-2 sm:py-3 rounded-lg border-2 font-semibold text-base flex items-center justify-center gap-2 hover:bg-green-50 transition-colors"
